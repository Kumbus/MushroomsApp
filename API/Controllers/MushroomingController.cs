...
namespace API.Controllers
{
    ...
    public class MushroomingController : ControllerBase
    {
        ...
        {
            var response = await _mushroomingService.GetAllMushroomingsAsync(parameters);
            if (!response.Success)
        ...
        {
            var response = await _mushroomingService.GetMushroomingByIdAsync(id);
            if (!response.Success)
        ...
        {
            var response = await _mushroomingService.CreateMushroomingAsync(dto);
            if (!response.Success)
                return BadRequest(response.Message);
        ...
        {
            var response = await _mushroomingService.UpdateMushroomingAsync(id, dto);
            if (!response.Success)
                return BadRequest(response.Message);
        ...
        {
            var response = await _mushroomingService.DeleteMushroomingAsync(id);
            if (!response.Success)
                return NotFound(response.Message);
